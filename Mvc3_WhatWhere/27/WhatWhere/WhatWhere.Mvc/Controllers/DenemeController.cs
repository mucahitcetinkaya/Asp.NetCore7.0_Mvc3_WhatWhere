...
namespace WhatWhere.Mvc.Controllers
{
    public class DenemeController : Controller
    {
       ...
       // TOWN ALANI
        ...
        public async Task<IActionResult> GetFullDataTown1()
        {
            var towns = await _townManager.GetTownFullDataAsync();
            var model = towns.Select(t => new TownViewModel
            {
                Id = t.Id,
                Ilce = t.Ilce,
                City = t.City,
        ...
        public async Task<IActionResult> GetFullDataTown2()
        {
