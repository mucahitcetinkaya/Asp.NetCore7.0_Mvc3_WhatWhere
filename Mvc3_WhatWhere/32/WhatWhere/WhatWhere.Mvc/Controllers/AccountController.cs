...
using WhatWhere.Mvc.EmailServices.Abstract;
...
namespace WhatWhere.Mvc.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //var subject = "WhatWhere Onay Maili";
                    //var body = $"<h1>WhatWhere Onay İşlemi</h1>" +
                    //    $"<p>" +
        ...
        public async Task<IActionResult> ForgotPassword(string email)
        {
            ...
            var subject = "WhatWhere Şifre Sıfırlama";
            var body = $"<h1>WhatWhere Şifre Sıfırlama İşlemi</h1>" +
                $"<p>" +
